...
wave plan are `specs/002-platform-thesis/spec.md`.
...
- **title** (short, imperative) and a **slug** (kebab-case, from the
  title)
- **wave** 1 to 8, which fixes the ordinal range (spec 002 §6):
...
- **domain**: `governance`, `l0-objects`, `l1-ledger`, `l2-domain`,
  `l3-evaluation`, `l4-trust`, `l5-projection`, `l6-policy`, `l7-edge`
